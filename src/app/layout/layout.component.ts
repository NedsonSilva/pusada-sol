...
import { ZuziPlatformService } from '@zuzi/services/platform';
import { ZUZI_VERSION } from '@zuzi/version/zuzi-version';
...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _zuziPlatformService: ZuziPlatformService
    ) {}
    ...
    ngOnInit(): void {
        ...
        combineLatest([
            ...
            this._zuziMediaWatcherService.onMediaQueryChange$([
        ...
        this._renderer2.addClass(
            this._document.body,
            this._zuziPlatformService.osName
        );
    }
