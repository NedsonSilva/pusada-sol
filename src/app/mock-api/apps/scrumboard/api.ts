...
import { ZuziMockApiService, ZuziMockApiUtils } from '@zuzi/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._zuziMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newList.id = ZuziMockApiUtils.guid();
        ...
        this._zuziMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newCard.id = ZuziMockApiUtils.guid();
        ...
        this._zuziMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newLabel.id = ZuziMockApiUtils.guid();
