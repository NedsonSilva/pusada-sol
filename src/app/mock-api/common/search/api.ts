...
import { ZuziNavItem, ZuziNavigationService } from '@zuzi/components/navigation';
...
{
    private readonly _defaultNavigation: ZuziNavItem[] = defaultNavigation;
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._zuziNavigationService.getFlatNavigation(this._defaultNavigation);
